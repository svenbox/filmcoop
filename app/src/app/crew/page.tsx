...
import { KLASS_TOOLTIP, SCENARIO_LABELS } from "@/lib/scenarios";
        ...
        {tab === "waterfall" && (
          <>
            <p className="section-intro">
              Så här fördelas filmens intäkter — i denna ordning. Välj ett
              scenario för att se vad din andel kan bli värd.
            </p>
